...
class EventPeriodTest {
    ...
    void 두_기간이_겹치는지_확인할_수_있다(EventPeriod eventPeriod1, EventPeriod eventPeriod2, boolean expected) {
        // when
        var result = eventPeriod1.isOverlappedWith(eventPeriod2);
    ...
    void 특정_날짜가_기간에_포함되는지_알_수_있다(LocalDateTime testDate, boolean expected) {
        ...
        var sut = EventPeriod.create(start, end);
